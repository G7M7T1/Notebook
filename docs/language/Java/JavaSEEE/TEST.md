---
sidebar_position: 2
sidebar_label: 'Improves Part 2st'
---
...
- 再下面是一些抽象类，最后是具体实现类，常用的有ArrayList,LinkedList,HashSet,HashMap,LinkedHashSet,LinkedHashMap等等
...
| 序号 | 迭代器方法描述                                               |
| :--- | :----------------------------------------------------------- |
| 1    | Java Iterator这里通过实例列出 Iterator 和 ListIterator 接口提供的所有方法。 |
